...
\text{cost}_{\text{{norm}}}&=\frac{\text{FNR}\cdot p\cdot \text{cost}_{01}+\text{FPR}\cdot (1-p)\cdot \text{cost}_{10}}{p\times \text{cost}_{01}+(1-p)\times \text{cost}_{10}}
\end{aligned}
$$